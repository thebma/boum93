...
function About()
{
    return (
        <div id="about">
            ...
            <svg class="about-transition" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#191923" fillOpacity="1" d="M0,160L80,181.3C160,203,320,245,480,261.3C640,277,800,267,960,266.7C1120,267,1280,277,1360,282.7L1440,288L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
        </div>
    )
}
